...
import { ShieldCheck, GraduationCap, Lock, Mail, UserPlus, Fingerprint, BadgeCheck, Presentation, Home } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background p-4 font-body">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center space-y-4">
          <div className="mx-auto h-24 w-24 relative cursor-pointer" onClick={() => router.push('/')}>
            {logoData ? (
              <Image 
        ...
        <Card className="border-border shadow-xl">
          ...
          <CardFooter className="flex flex-col gap-4 border-t border-border pt-6">
            <div className="flex gap-4">
              <Button variant="ghost" size="sm" className="font-bold gap-2" onClick={() => router.push('/')}>
                <Home className="h-4 w-4" /> Home
              </Button>
              <Button variant="ghost" size="sm" className="font-bold gap-2" onClick={() => router.push('/presentation')}>
                <Presentation className="h-4 w-4" /> Case Study
              </Button>
            </div>
            <p className="text-[10px] text-muted-foreground text-center uppercase font-black tracking-widest">
